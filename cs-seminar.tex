...
Combining edge and cloud computing has shown to be advantageous, results show that both execution speed could be increased and energy consumption could be decreased by a factor 20 \cite{
